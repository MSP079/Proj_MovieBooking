...
class BookShow extends Component {
    ...
    locationChangeHandler = ((event) => {
        ...
        this.setState({ theatres: newTheatres });// eslint-disable-next-line
    }).bind(this);
    ...
    theatreChangeHandler = ((event) => {
        ...
        this.setState({ languages: newLanguages });// eslint-disable-next-line
    }).bind(this);
    ...
    languageChangeHandler = ((event) => {
        ...
        this.setState({ showDates: newShowDates });// eslint-disable-next-line
    }).bind(this);
    ...
    showDateChangeHandler = ((event) => {
        ...
        this.setState({ unitPrice: unitPrice, availableTickets: availableTickets });// eslint-disable-next-line
    }).bind(this);

    ticketsChangeHandler = ((event) => {
        this.setState({ tickets: event.target.value.split(",") });// eslint-disable-next-line
    }).bind(this);
